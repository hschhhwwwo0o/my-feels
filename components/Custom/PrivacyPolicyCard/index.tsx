...
const PrivacyPolicyCard: FunctionComponent = () => {
  return (
    <div
      role={"contentinfo"}
      className="border-2 border-[#EAEAEA] dark:border-[#2D2D2D] w-full rounded-3xl px-5 pt-6 pb-6 shadow-md mt-6"
    >
      ...
      <div className="text-[#444444] dark:text-[#B2B2B2] mt-[14px] text-sm lg:text-base text-justify">
        Developer built the "My Feels" app as open source app. This SERVICE is provided by Developer
